        ...
        <img class="content-image"
            ...
            <span class="content-tag">
                ...
                <span class="shop-message-detail">{{info.score}}</span>
                    <span class="shop-message-detail">{{'sell'+' '+' '+info.sellCount}}</span>
                    <span class="shop-message-detail">
                        {{info.description}}
                    <span>{{'about'+' '+info.deliveryTime+' '+'minutes'}}</span>
                    </span>
            ...
            <span class="content-tag">
            <span class="mini-tag">Order</span>
                    </span>
            <span class="activity-content ellipsis">New users will be reduced by 17 Dollars</span>
                </div>
            </div>
