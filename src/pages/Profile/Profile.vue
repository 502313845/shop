            ...
            <div class="user-info">
             ...
             <p class="user-info-top" v-else>{{'Welcome!'+'  '+userInfo.name}}</p>
              ...
              <p>
                ...
                <span class="icon-mobile-number">No connect phone</span>
              </p>
            </div>
            <span class="arrow">
        ...
        <section class="profile_info_data border-1px">
          <ul class="info_data_list">
            <a href="javascript:" class="info_data_link">
              ...
              <span class="info_data_bottom">Amount</span>
            </a>
            <a href="javascript:" class="info_data_link">
              <span class="info_data_top"><span>0</span>个</span>
              <span class="info_data_bottom">Discount</span>
            </a>
            <a href="javascript:" class="info_data_link">
              <span class="info_data_top"><span>0</span>分</span>
              <span class="info_data_bottom">Points</span>
            </a>
          </ul>
        </section>
